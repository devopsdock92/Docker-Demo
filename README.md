...
```
git clone https://github.com/devopsdock92/Docker-Demo
cd  examples
```
...
```
    ...
    Successfully tagged devopsdock92/my-first-docker-image:latest
```
...
devopsdock92/my-first-docker-image   latest    960d37536dcd   26 seconds ago   467MB
...
```
docker run -it devopsdock92/my-first-docker-image
```
